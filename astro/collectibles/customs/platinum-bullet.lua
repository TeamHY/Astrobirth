...
if EID then
    Astro:AddEIDCollectible(Astro.Collectible.PLATINUM_BULLET, "백금 탄환", "...", "방을 클리어 할 때마다 공격력과 연사가 0.02씩 증가합니다.#해당 아이템은 연사 배수 아이템 상관없이 항상 고정적인 수치가 증가됩니다.#중첩 시 다음 증가량부터 적용됩니다.")
end
