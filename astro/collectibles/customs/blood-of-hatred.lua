...
if EID then
    Astro:AddEIDCollectible(Astro.Collectible.BLOOD_OF_HATRED, "증오의 피", "...", "방 입장 시 25%의 확률로 적을 출혈시킵니다.#!!! {{LuckSmall}}행운 수치 비례: 행운 30 이상일 때 100% 확률 ({{LuckSmall}}행운 1당 +2.5%p) #블랙 하트 2개가 증가됩니다.")
end
